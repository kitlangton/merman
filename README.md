...
```txt
            .-"""""-.          /-------------------------------------------------------------\
         .-'  _   _  '-.      /  merman turns Mermaid-ish text into terminal diagrams.        \
       .'    (o) (o)    '.   /---------------------------------------------------------------\
      /        .-.        \  |                                                             |
     ;    .--./___\.--.    ; |   +----------------+      +-------------------------+        |
     |   /   /_____\   \   | |   | Mermaid source | ---> | detect diagram family   |        |
     |   \__/  '-'  \__/   | |   | flow/state/seq |      | flowchart/state/seq     |        |
     ;        /| |\        ; |   +----------------+      +-----------+-------------+        |
      \      /_|_|_\      /  |                                       |                      |
       '.      | |      .'   |                                       v                      |
         '-.   | |   .-'     |   +----------------+      +-------------------------+        |
            '--|_|--'        |   | parse AST      | ---> | layout + route + style  |        |
              /| |\          |   | tiny Mermaid   |      | boxes, edges, colors    |        |
             /_|_|_\         |   +----------------+      +-----------+-------------+        |
           .'  | |  '.       |                                       |                      |
          /    | |    \      |                                       v                      |
         ;  .--| |--.  ;     |   +----------------+      +-------------------------+        |
         | /   | |   \ |     |   | render target  | ---> | stdout / snapshots /    |        |
         | \__.| |.__/ |     |   | CLI or OpenTUI |      | live OpenTUI renderable |        |
         ;     | |     ;     |   +----------------+      +-------------------------+        |
          \   /| |\   /      |                                                             |
